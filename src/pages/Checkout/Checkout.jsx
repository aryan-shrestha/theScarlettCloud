...
const Checkout = () => {
  ...
  const [isInitiatingKhalti, setIsInititatingKhalti] = useState(false);
  ...
  const esewaSubmitButtonRef = useRef(null);
  ...
  //   if (validateFields()) {
  //     esewaSubmitButtonRef.current.click();
  //   }
  // };

  const handleKhaltiPayment = async () => {
    if (validateFields()) {
      setIsInititatingKhalti(true);
      try {
        ...
        <div className="flex flex-col mt-8 space-y-6 lg:flex-row lg:space-x-12 ">
          <div className="flex flex-col  space-y-2 p-1 w-full">
            ...
            {/* <EsewaPayment
              ...
              esewaSubmitButtonRef={esewaSubmitButtonRef}
            /> */}
          </div>
          <div className="flex flex-col h-fit lg:w-[40%] space-y-4 p-4 border-[1px] border-neutral-800 rounded-xl text-neutral-800">
            ...
            <div className="pt-4 flex flex-col space-y-4">
              ...
              {/* <button
                className="py-2 h-14 flex items-center justify-center border-[1px] border-[#61BC47] text-[#61BC47] font-medium rounded-xl"
